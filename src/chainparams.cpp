...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "1532407187 07/24/2018 today is the day alfa start new block.";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1532407187, vin, vout, 0);
       
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1532407187;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 481547;       

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000cf44af0baa109673108d80cbd194cfe131c44ca15cfaf5e38382eadb6446"));
        assert(genesis.hashMerkleRoot == uint256("0xa3f453cdc2292d7d5466caaa90b398a4aad4ddcbe7dc8af4bf7434f9c2d2d1cd"));
