...
private slots:
    ...
    QString BuyAFA(QString OrderType, double Quantity, double Rate);
    QString SellAFA(QString OrderType, double Quantity, double Rate);
