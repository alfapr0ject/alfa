...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 3000) (2, 10000) (3, 25000) (4, 88000) (5, 500000); // 0% - 0% - 4% - 7% - 15%

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 3) (2, 10) (3, 26) (4, 95) (5, 575); // 3 - 10 - 26 - 95 - 575

//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 AFA, signature to prove
